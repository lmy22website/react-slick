...
var InnerSlider = /*#__PURE__*/ (function(_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _defineProperty(
      ...
      "offsetLazyLoad",
      function() {
        var lazyLoadOffset = _this.props.lazyLoadOffset;
        var slidesToLoad = [];

        for (
          var index = _this.state.currentSlide - 1;
          index >= _this.state.currentSlide - lazyLoadOffset;
          index--
        ) {
        ...
        for (
          ...
          _index <= _this.state.currentSlide + lazyLoadOffset;
          _index++
        ) {
          slidesToLoad.push(_index);
        }

        slidesToLoad = slidesToLoad.filter(function(index) {
          return index >= 0 && !_this.state.lazyLoadedList.includes(index);
        });
    ...
    _defineProperty(
      ...
      function() {
        ...
        for (
          var _index2 = _this.state.currentSlide - 1;
          _index2 >= -(0, _innerSliderUtils.getPreClones)(spec);
          _index2--
        ) {
